...
// DOC include start: DummyAccelTLRocketConfig
class DummyAccelTLRocketConfig extends Config(
  new nttAccel.WithDummy(useAXI4=false, useBlackBox=false) ++          // Use DummyAccel with Tilelink interface
  new freechips.rocketchip.subsystem.WithNBigCores(1) ++
  new chipyard.config.AbstractConfig)
// DOC include end: DummyAccelTLRocketConfig
